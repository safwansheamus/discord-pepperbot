...
async def credits(ctx, member: discord.Member = None):
    ...
    embed = discord.Embed(title="Pepper Develop by.",
                          description="Mangendre Corp. X NES Extrem", colour=discord.Colour.dark_red())
...
async def info(ctx, member: discord.Member = None):
    ...
    embed = discord.Embed(title="Welcome Our Server",
                          description="Pepper Ready to Seshhhh with Smile :) ", colour=discord.Colour.random())
    ...
    embed.add_field(name="Command Help !",
                    value="If u need help just command `?help`", inline=False)
...
async def button(ctx):
    ...
    embed = discord.Embed(
        title='Button', description='Click the button to send a message')

    # Add the button
    embed.add_field(
        name='Button', value='[Click here](https://google.com)', inline=False)
